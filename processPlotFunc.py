...
# ECG Signal
#ax.plot(t, normalizedECG, label='Normalized ECG')
...
# PPG Signal
ax[0].plot(t, normalizedPPG, label='Normalized PPG')
ax[0].set_title('PPG Signal')
ax[0].set_xlabel('Time (s)')
ax[0].set_ylabel('Amplitude (arbitrary units)')
ax[0].set_xticks(np.arange(min(t), max(t), 1))
ax[0].grid()
...
ax[1].set_xticks(np.arange(min(t), max(t), 1))
ax[1].grid()

# Combined plot with peaks shown
ax[2].plot(t, normalizedPPG, label='Normalized PPG')
...
ax[2].set_title('Combined ECG and PPG Signals with peaks identified')
ax[2].set_xlabel('Time (s)')
ax[2].set_ylabel('Amplitude (arbitrary units)')
ax[2].set_xticks(np.arange(min(t), max(t), 1))
